...
class Title(cocos.layer.ColorLayer):
	...
	# self.label = Label('Breakout Clone',
	# 			   font_name='ALISON',
	# 			   font_size=72,
	# 			   bold=True,
...
class Start(Menu):
	def __init__(self, start):
		super(Start, self).__init__('Breakout Clone')
		self.start = start
		self.menu_hmargin = 2
		self.menu_vmargin = 3
		self.font_title = {
		...
		items = []
		items.append(MenuItem('Star', self.on_new_game))
		items.append(MenuItem('Level Creater', self.on_new_scene))
...
if __name__ == "__main__":
	...
	main_scene.add(Start(hello_layer))
